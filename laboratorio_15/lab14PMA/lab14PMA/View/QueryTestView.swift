            ...
            ScrollView {
                LazyVStack(spacing: 10) {
                    ...
                    querySection(title: "LIMIT Queries") {
                        ...
                        queryButton("Top 5 Popular", color: .pink) {
                            queryService.getTop5Popular()
                        }
                    }

                    // TAREA Actividad 03
                    querySection(title: "TAREA") {
                        queryButton("All Posts", color: .teal) {
                            queryService.getAllPosts()
                        }
                        queryButton("Most Popular", color: .red) {
                            queryService.getMostPopular()
                        }
                    }
