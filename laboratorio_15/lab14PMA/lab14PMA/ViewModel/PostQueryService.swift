...
class PostQueryService: ObservableObject {
    ...
    // MARK: - TAREA Actividad 03

    // Obtener TODOS los posts
    func getAllPosts() {
        isLoading = true
        queryDescription = "SELECT * (all posts)"
    ...
    // Obtener los MÁS POPULARES (ordenados por likes desc)
    func getMostPopular() {
        isLoading = true
        queryDescription = "ORDER BY likes DESC"
